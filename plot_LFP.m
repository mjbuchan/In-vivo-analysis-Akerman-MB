...
data_folder     	= '/Volumes/PS2Akermanlab/Joram/Data/In vivo/CBLK_2019-03-27_19-06-42_3';       % currently set to 'cd' so code should work if script is run from directory containing the data
...
% Data filtering
LFP_band_max        = 4000;      % LFP bandpass filter max
LFP_band_min        = 300;       % LFP bandpass filter min
...
switch probe_type
    case '16ch'
        % 16ch linear silicon A16 probe neuronexus: [20 4 29 13 18 2 30 14 17 1 32 16 31 15 19 3]
        chan_map        = [20 4 29 13 18 2 30 14 17 1 32 16 31 15 19 3];
    case '32ch'
        % 32Ch linear A32 probe neuronexus
        chan_map        = [16 32 1 17 14 30 3 19 8 24 7 29 9 25 15 20 10 23 2 28 6 26 5 21 11 31 4 27 12 22 13 18];
end
...
figure(1)
plot(time_vect, LFP_trace_resampled);
figure(2)
plot(spectrogram(LFP_trace_resampled));
