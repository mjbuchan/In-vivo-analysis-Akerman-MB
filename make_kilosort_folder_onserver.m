...
% KILOSORT COPYFILES
KS_copy_file_folder	= '/Volumes/PS2Akermanlab/MJB/Spike_sorting/Kilosort copyfiles';

% DATA IN
data_folder         = '/Volumes/PS2Akermanlab/MJB/In_Vivo/';
target_date         = '2019_05_14';
target_file_nrs     = [4 5 7 8 9 10 11 12];
 
% DATA OUT
sorting_folder      = '/Volumes/PS2Akermanlab/MJB/Spike_sorting'; %
