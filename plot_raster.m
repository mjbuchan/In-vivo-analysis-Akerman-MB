...
data_file       = '/Users/matthewbuchan/Desktop/Work/Scripts/Extracted data/Drive/2019_08_09/2019_08_09-16-Drive.mat';% 'Full/Path/To/Processed/Data_file.mat' Full path to data file, preprocessed into trial-synchronised spike time data using ephys_metadata_reader
...
condition_nr    = 3;     % Which condition nr to make plots for? Use 1 for data with only a single condition
channels        = [1:32];   % Which channels to include
trials          = [1:48]; %Which trial numbers to include. Use a single trial to plot a 'canonical' raster plot

% How much of the data to show and what time bins to use?
psth_win        = [0 6];  % sets x-axis values for all plots
...
offset_val      = 3;   % value for offset (correcting for drift caused by bug in PulsePal protocol)
