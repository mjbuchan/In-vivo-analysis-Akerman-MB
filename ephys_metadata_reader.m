%% 
metadata_file       = '/Volumes/PS2Akermanlab/Joram/Data/in vivo metadata/Metadata File.xlsx';
data_folder         = '/Volumes/PS2Akermanlab/MJB/In_vivo';   %'/Volumes/Akermanlab-1/Joram/In vivo mouse data'; % Where are the data? 
% data_folder         = '/Users/matthewbuchan/Desktop/Work/Spike_sorting';   %'/Volumes/Akermanlab-1/Joram/In vivo mouse data'; % Where are the data? 


save_folder         = '/Users/matthewbuchan/Desktop/Work/Scripts/Extracted data';  %/Volumes/Akermanlab-1/Joram/Extracted data'; % Where to save output
start_date          = '2019_08_09';     % format: 'yyyy_mm_dd'; Process files from this date onwards
end_date            = '2019_08_09';     % format: 'yyyy_mm_dd'; Process files up until this date
...
trials_from_whisk   = true;          	% discard trial information from ADC channels and determine trials based on whisker instead?
whisk_buffer        = 0.0625;           %3 if using whisk stim to divide recording into trials (above), trials start whisk_buffer (in seconds) before the whisker stim onset, and end 2*whisk buffer after whisker stim ONSET
