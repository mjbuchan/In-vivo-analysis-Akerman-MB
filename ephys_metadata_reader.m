...
data_folder         = '/Volumes/PS2Akermanlab/Joram/Data/In vivo';   %'/Volumes/Akermanlab-1/Joram/In vivo mouse data'; % Where are the data? 
...
data_output         = 'new';            % 'new': improved data structure, or 'old': 'channels' style data structure
