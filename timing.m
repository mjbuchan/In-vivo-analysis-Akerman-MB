...
%% Input variables 
data_file       = ['/Users/matthewbuchan/Desktop/Work/Scripts/Extracted data/Timing/2019_08_06/2019_08_06-16-Timing.mat'];

q_reload        = 1;

%% PSTH settings
early_resp_win  = [0.005 0.05]; % response window for assessing 'early' response (spike count is from this time window)
...
channels        = [1:26];    % which recording sites / channels to include
